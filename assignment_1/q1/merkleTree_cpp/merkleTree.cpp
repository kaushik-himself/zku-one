...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[9]); // line circom 12
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[3]); // line circom 12
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[9]); // line circom 12
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[5]); // line circom 12
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[2])) + 0);
{
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[3]); // line circom 12
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
uint csoffset = mySignalStart+1782;
for (uint i = 0; i < 1; i++) {
...
Fr_add(&expaux[4],&lvar[1],&circuitConstants[3]); // line circom 29
Fr_shl(&expaux[2],&circuitConstants[3],&expaux[4]); // line circom 29
Fr_lt(&expaux[0],&lvar[2],&expaux[2]); // line circom 29
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[1],&circuitConstants[5]); // line circom 30
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_geq(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 27
